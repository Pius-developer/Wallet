...
<div class="module module-consultation pull-left">
	<a class="btn btn--secondary btn--bordered btn--rounded" href="backend/login.php"  style="background-color: orange;">Login</a>
</div>
...
<section id="page-title" class="page-title bg-overlay bg-overlay-dark bg-parallax">
	<div class="bg-section">
		<img src="assets/images/blog/standard/1.jpg" alt="Background"/>
	</div>
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12">
				<div class="title title-6 text-center">
					...
					<ol class="breadcrumb">
						...
						<li class="active" style="color:orange;">Security</li>
					</ol>
				</div><!-- .title end -->
			</div><!-- .col-md-12 end -->
		</div><!-- .row end -->
...
<!-- Featured #2
============================================= -->
<section id="featured2" class="featured featured-2 pb-50" style="background-color: black;">
    <div class="container">
    	...
    	<div class="row clearfix">
            <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3">
                <div class="heading heading-1 mb-50 text--center">
                    ...
                    <h2 class="heading--title" style="color: #fff;">Elite <span style="color:orange;">Key</span> Chain </h2>
                    <p class="heading--desc mb-0">We operate a standard and secure system where your crypto assets is safe with our high encription database <a class="btn btn--primary btn--rounded mr-30" href="login.php" style="background-color: orange;">Sign up for free</a>  </p>
                </div>
            </div>
            <!-- .col-md-6 end -->
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp" data-wow-delay="100ms">
                <div class="feature-card">
                    ...
                    <div class="feature-card-content">
                        <h3 class="feature-card-title" style="color: #fff;">Elite Key Chain cold storage</h3>
                        <p class="feature-card-desc">We use a multisignature digital signature scheme (multisig) to eliminate single points of failure and improve our resilience against the loss or compromise of any individual private key.</p>
                    </div>
                </div>
            </div>
            <!-- .col-md-4 end -->
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp" data-wow-delay="200ms">
                <div class="feature-card">
                    ...
                    <div class="feature-card-content">
                        <h3 class="feature-card-title" style="color: #fff;">Elite Key Chain hot wallet</h3>
                        <p class="feature-card-desc">We follow the principle of least-privilege by applying tiered, role-based access-controls to our production environment. Administrative access requires multi-factor authentication.</p>
                    </div>
                </div>
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp" data-wow-delay="300ms">
                <div class="feature-card">
                    ...
                    <div class="feature-card-content">
                        <h3 class="feature-card-title" style="color: #fff;">Account security</h3>
                        <p class="feature-card-desc">Two-Factor Authentication (2FA) is required when you log in to your account. We hash and salt your password and use encryption to secure your personal information and other sensitive information.</p>
                    </div>
                </div>
            </div>
            <!-- .col-md-4 end -->
			...
			<div class="row clearfix">
				<div class="col-xs-12 col-sm-4 col-md-3 footer--widget widget-about">
					<div class="widget-content">
						<img class="footer-logo" src="assets/images/log/logo.png" alt="logo" style="height:100px; width: 150px;">
						<p>Exchange Cryptocurrency at the Best Rate by getting the best offer from all the exchanges at one place.</p>
						<div class="copyright">
							<a target="_blank" href="index.php">copyright Elite Key Chain 2022</a>
						</div>
					</div>
				</div><!-- .col-md-3 end -->
				<div class="col-xs-12 col-sm-4 col-md-2 footer--widget widget-links">
					...
					<div class="widget-content">
						<ul>
							...
							<li><a href="about.php">Latest News</a></li>
				...
				<div class="col-xs-12 col-sm-4 col-md-2 footer--widget widget-links">
					<div class="widget-title">
						<h5 style="color:orange;">Help & Support</h5>
					</div>
					<div class="widget-content">
						<ul>
							<li><a href="about.php">Exchange Rates</a></li>
							<li><a href="about.php">Supported Currencies</a></li>
							<li><a href="about.php">Asset Introduction</a></li>
							<li><a href="about.php">Affiliate Program</a></li>
							<li><a href="contact.php">Help & Wiki</a></li>
						</ul>
					</div>
				</div><!-- .col-md-2 end -->
				...
				<div class="col-xs-12 col-sm-4 col-md-2 footer--widget widget-links">
					<div class="widget-title">
						<h5 style="color:orange;">How To</h5>
					</div>
					<div class="widget-content">
						<ul>
							<li><a href="backend/login.php">Buy Bitcoin</a></li>
							<li><a href="backend/login.php">Buy Bitcoin Cash</a></li>
							<li><a href="backend/login.php">Buy Ethereum</a></li>
							<li><a href="backend/login.php">Buy Litecoin</a></li>
							<li><a href="backend/login.php">Status</a></li>
						</ul>
					</div>
				</div><!-- .col-md-2 end -->
				...
				<div class="col-xs-12 col-sm-4 col-md-3 footer--widget widget-newsletter">
					<div class="widget-title">
						<h5 style="color:orange;">Stay Updated</h5>
					</div>
					<div class="widget-content">
