      ...
      <div class="main-content">
            ...
            <div class="card">
                  <div class="card-header bg-dark">
                    <h4 class="col-orange"> Deposit Request</h4>
                  </div>
                  <div class="card-body">
                      ...
                      <table class="table table-striped table-hover" id="save-stage" style="width:100%;">
                        <thead >
                          <tr>
                            ...
                            <th style="color:black" colspan="1">Action</th>
                          </tr>
                        </thead>
                        <tbody>
                        <?php

$sql = "SELECT * FROM  depositrequests ORDER BY id DESC";
      ...
      $uname= $data['username'];
            ...
            $depid= $data['depositid'];
                            ...
                            echo "<tr> ";
                                            ...
                                            echo '<td>'.$ttype. '</td>';
                                            //echo '<td>'.$current. '</td>';
                    echo "<td> <form method='POST' action='actions/seen.php'><input type='hidden' name='depid' value='$depid'> <button type='submit' name='seen' class='btn bg-green'><i class='fas fa-eye'></i> seen</button></form></td>";                                          
