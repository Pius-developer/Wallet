      ...
      <div class="main-content">
            ...
            <div class="card">
                  <div class="card-header bg-dark">
                    <h4 class="col-orange">Proof Of Payments</h4>
                  </div>
                  <div class="card-body">
                   <div class="row">
                ...
                echo "<div class='card card-primary'>";
                  ...
                  echo  "<p style='color:black'>Proof of payment for $uname</p>";
                 echo "</div>";
                  echo "<div class='card-body'>";
                   echo "<img height='100%' width='100%' src='uploads/".$img." '>";
                   echo"<br><br>";
                   echo"<form method='POST' action='actions/deleteproof.php'><input type='hidden' name='invid' value='$proofid'> <button type='submit' name='delete' class='btn btn-danger'><i class='fas fa-trash-alt'></i> delete</button></form>";
                  echo "</div>";
