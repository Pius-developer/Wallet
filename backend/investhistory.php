      ...
      $date= $data['amount'];
            ...
            $depid= $data['investid'];
                            ...
                            echo "<tr> ";
                                            ...
                                            echo '<td>'.$earn. '</td>';
                          echo "<td> <form method='POST' action='actions/deleteinv.php'><input type='hidden' name='invid' value='$depid'> <button type='submit' name='delete' class='btn' style='background-color:#083d6b;color:white'><i class='fas fa-trash-alt'></i> Delete</button> </form></td>";
